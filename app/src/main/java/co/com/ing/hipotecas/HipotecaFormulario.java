...
public class HipotecaFormulario extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        delegate.setContentView(R.layout.activity_hipoteca_formulario);
...
//
    ...
    private void consultar(long id) throws SQLException
    {
        ...
        Hipoteca hipoteca = Hipoteca.cursorToHipoteca(this, cursor);
        nombre.setText(hipoteca.getNombre());
        condiciones.setText(hipoteca.getCondiciones());
        contacto.setText(hipoteca.getContacto());
        telefono.setText(hipoteca.getTelefono());
    ...
    private void guardar() throws SQLException {
        ...
        if (this.modo == MainActivity.C_EDITAR)
        {
